...
export default function ComparisonView(): React.JSX.Element {
  ...
  // Build sorted equivalence rows from static data — computes once
  ...
  const hasSelections = provider != null && selectedServices.length > 0

  // Build comparison data (only when services are selected)
  type RowData = {
    serviceId: string
    sourceName: string
  ...
  let rows: RowData[] = []
  let totals: Record<CloudProvider, number | null> = { aws: null, gcp: null, azure: null }
  let cheapestTotal: CloudProvider | null = null
  ...
  if (hasSelections) {
    ...
    cheapestTotal = cheapestProvider(totals)
  }
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-auto p-4">
        ...
        {/* Cross-Provider Equivalence Reference — always visible */}
        <div className="mt-4">

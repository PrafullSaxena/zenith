...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-xl border border-white/[0.1] bg-popover/80 backdrop-blur-2xl p-1 text-popover-foreground shadow-[0_8px_32px_rgba(0,0,0,0.4)]",

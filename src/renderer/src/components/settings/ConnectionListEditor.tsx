...
const selectClass =
  'w-full rounded-lg border border-white/8 bg-white/3 px-3 py-1.5 text-sm text-foreground focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary/30 transition appearance-none'
    ...
    <div className="space-y-3">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {connections.map((conn, index) => (
                ...
                >
                  <td className="px-3 py-2 text-foreground font-medium">{conn.name}</td>
                  <td className="px-3 py-2 text-muted-foreground truncate max-w-[200px]">
                    {conn.host}
                  </td>
                  <td className="px-3 py-2 text-muted-foreground">{conn.port}</td>
                  <td className="px-3 py-2 text-muted-foreground">{conn.readStrategy}</td>
      ...
      {connections.length === 0 && !showForm && (
        <div className="rounded-xl border border-dashed border-white/10 bg-black/10 px-4 py-8 text-center">
          <Database size={24} className="mx-auto mb-2 text-muted-foreground/30" />
      ...
      {/* Add connection form */}
      {showForm && (
        <div className="rounded-xl border border-white/5 bg-black/20 backdrop-blur-md p-4 space-y-3">
          <input
            type="text"
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg border border-border/50 bg-card px-3 py-1.5 text-xs font-medium text-muted-foreground hover:text-foreground hover:bg-secondary transition disabled:opacity-50"
            >
              {isTesting ? (
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg bg-primary px-3 py-1.5 text-xs font-medium text-background hover:bg-primary/90 transition disabled:opacity-50"
            >
              {isAdding ? (
                <Loader2 size={13} className="animate-spin" />
              ) : (
            ...
            <button
              ...
              className="rounded-lg px-3 py-1.5 text-xs font-medium text-muted-foreground hover:text-foreground transition"
            >
              Cancel
            </button>
          </div>

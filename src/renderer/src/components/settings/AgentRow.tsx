        ...
        {provider.requiresApiKey ? (
          <div className="flex items-center gap-2">
            {isEditingKey ? (
              ...
              <>
                {provider.hasApiKey ? (
                  <span className="text-[13px] text-muted-foreground">••• Set</span>
                ) : (
                  <span className="text-[13px] text-muted-foreground/50">Not set</span>
                )}
                <button
          ...
          <span className="text-[13px] text-muted-foreground/50">&mdash;</span>
        )}
      </td>
      ...
      <td className="px-4 py-2.5">
        <div className="flex items-center gap-2">
          ...
          {provider.isCustom && onRemove && (
            <button
              onClick={onRemove}
              className="rounded-lg px-2 py-0.5 text-[11px] text-muted-foreground transition hover:text-red-400 hover:bg-red-500/10"
            >
              Remove
            </button>
          )}

 ...
 *
 * Reads `general.coloredPdf` setting to determine visual theme.
 *
 * @param win - The parent browser window (for modal dialog positioning)
 * @param data - The markdown text and optional title
 * @returns The file path written to, or null if the user cancelled
 */
export async function exportTextCraftPdf(
  win: BrowserWindow,

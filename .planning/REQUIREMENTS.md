...
- [ ] **GROOM-03**: Per task, AI produces: priority score (P1/P2/P3), suggested action (do/delegate/defer/delete), linked Jira ticket (if found), evidence summary
- [ ] **GROOM-04**: For research-mode tasks (complex/ambiguous), AI produces a mini-summary with relevant links from Google, Confluence, and Jira plus a suggested next-step roadmap
...
| GROOM-03 | Phase 18 | Pending |
| GROOM-04 | Phase 18 | Pending |
